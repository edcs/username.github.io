...
Cylon = (function() {
  ...
  function Cylon(element1) {
    var el, j, len, letter, text;
  ...
  Cylon.prototype.step = function(time, delta) {
    var a, el, i, j, len, ref, results, rgb;
    ref = this.letters;
    results = [];
    for (i = j = 0, len = ref.length; j < len; i = ++j) {
      ...
      if (Modernizr.csstransforms3d) {
        results.push(el.style[this.tprop] = "rotateX(" + (-20 + a * 40) + "deg)");
      } else {
        results.push(void 0);
      }
    }
...
},{"./vendor/ready":2,"browsernizr":3,"browsernizr/test/css/rgba":31,"browsernizr/test/css/transforms3d":32}],2:[function(require,module,exports){
/*!
...
},{"./lib/Modernizr":4,"./lib/ModernizrProto":5,"./lib/classes":6,"./lib/setClasses":22,"./lib/testRunner":28}],4:[function(require,module,exports){
...
},{"./tests":30}],6:[function(require,module,exports){
...
},{"./slice":23}],14:[function(require,module,exports){
...
},{"./ModernizrProto":5}],22:[function(require,module,exports){
var Modernizr = require('./Modernizr');
var docElement = require('./docElement');
...
},{"./Modernizr":4,"./docElement":10}],23:[function(require,module,exports){
...
},{"./classes":6}],24:[function(require,module,exports){
var ModernizrProto = require('./ModernizrProto');
...
},{"./ModernizrProto":5,"./testPropsAll":27}],25:[function(require,module,exports){
var is = require('./is');
require('./fnBind');
...
},{"./ModernizrProto":5,"./cssomPrefixes":9,"./domPrefixes":11,"./is":16,"./prefixes":21,"./testDOMProps":25,"./testProps":26}],28:[function(require,module,exports){
var tests = require('./tests');
var Modernizr = require('./Modernizr');
var classes = require('./classes');
var is = require('./is');
...
},{"./Modernizr":4,"./classes":6,"./is":16,"./tests":30}],29:[function(require,module,exports){
var ModernizrProto = require('./ModernizrProto');
var injectElementWithStyles = require('./injectElementWithStyles');
...
},{"./ModernizrProto":5,"./injectElementWithStyles":15}],30:[function(require,module,exports){
...
},{"./../../lib/Modernizr":4,"./../../lib/createElement":8}],32:[function(require,module,exports){
var Modernizr = require('./../../lib/Modernizr');
...
},{"./../../lib/Modernizr":4,"./../../lib/docElement":10,"./../../lib/testAllProps":24,"./../../lib/testStyles":29}]},{},[1]);
